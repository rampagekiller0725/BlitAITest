            ...
            <div className="flex items-center justify-between h-11">
              <div className="flex items-center w-full">
                ...
                <div className="ml-auto flex items-center space-x-3">
                  <Link to="/login">
                    <button className="border border-transparent w-[83px] h-11 rounded-lg text-md text-gray-600 font-semibold hover:text-gray-900">
                      Log in
                    </button>
                  </Link>
                  <Link to="/signup">
                    <button className="shadow-xs bg-primary-600 hover:bg-primary-700 active:bg-primary-800 hover:transition duration-150 shadow-lg hover:shadow-primary-600/50 w-[95px] h-11 rounded-lg text-md text-white font-semibold">
                      Sign up
                    </button>
                  </Link>
                </div>
