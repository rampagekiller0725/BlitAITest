...
import { selectEmail, selectUsername } from "state/reducers/authSlice";
...
function SidebarFooter({ projectId }: SidebarFooterProps) {
  ...
  return (
    <footer className=" pt-4 px-3 bg-transparent">
      <button
        className="flex items-center p-2 text-sm font-normal rounded-lg"
        onClick={(e) => {
      ...
      >
        ...
        <span className="flex-1 ml-3 whitespace-nowrap text-base font-semibold text-[#344054]">
      ...
      <div className="flex items-center px-4 py-4 mt-2  bg-[#F9FAFB] rounded-lg">
        <div className="w-full">
          ...
          <div
            dangerouslySetInnerHTML={{ __html: projectInfo.info.status }}
          ...
          <div className="text-center mt-2">
            <div className="relative pt-1">
              <div className="overflow-hidden h-2 text-xs flex rounded-md bg-[#EAECF0]">
                <div
                  style={{ width: `${projectInfo.info.percentage}%` }}
                  className="rounded-md shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[#7F56D9]"
                ></div>
              </div>
            </div>
          </div>
      ...
      <div className="my-2 flex items-center p-2 text-sm font-normal">
        <div className="relative w-full">
          <div className="text-sm font-semibold text-[#344054]">John Smith</div>
          ...
          <div className="text-xs">
            <button
              ...
              className="absolute top-0 -right-1 flex items-center px-2 py-1 text-sm font-normal rounded"
            >
              {isLoading ? (
                <svg
                  aria-hidden="true"
